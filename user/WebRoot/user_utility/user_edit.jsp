...
<html>
  <head>
    ...
    <title>编辑用户</title>
	<link type="text/css" rel="stylesheet" href="css/user_edit.css" />
	    ...
	    <div id="mid_middle1">
		    <table id="table1" cellspacing="0" cellpadding="0">
			    ...
			    <tr height="30px">
				    ...
				    <td class="input" width="300px" align="center"><input style="width:250px;" value="张鹏"/></td>
			    </tr>
			    <tr height="30px">
				    ...
				    <td class="input" width="325px" align="center"><input style="width:250px;" value="******"/></td>
			    </tr>
		    </table>
	    </div>
	    <div id="mid_middle2">
