...
public class StudentReason extends HttpServlet {

	/**
	 * Constructor of the object.
	 */
	public StudentReason() {
		super();
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if(request.getSession(false) != null ){
			...
			work.updatereason(username, content);
			work.updateifplan(username, if_plan);
			...
			request.getSession().setAttribute("ifplan", if_plan);
			
			String path = request.getContextPath();
			String basePath = request.getScheme()+"://"+request.getServerName()+":"+request.getServerPort()+path+"/";
			response.sendRedirect(basePath+"jsp/temp_student.jsp");
		}
		else{
			String path = request.getContextPath();
			String basePath = request.getScheme()+"://"+request.getServerName()+":"+request.getServerPort()+path+"/";
